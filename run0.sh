...
# V0-RLSL
# python3 -m spinup.run ppo1 --exp_name testt --env CovidWorld-v0 --epochs 30 --seed 5000;
...
# python Supervised_Learning_test.py --train ./data/feature831.csv --test ./data/infection831.csv --model ./model/model_new831.pth 
