...
# @Last Modified time: 2023-08-31 20:12:20
import gym
...
class CovidEnvnotest(gym.Env):
    ...
    def __init__(self):
        ...
        self.sum1 = None
        self.sum2 = None
        self.model.load_state_dict(torch.load('/users/PCON0023/xueqiao/miniconda3/envs/spinningup/lib/python3.6/site-packages/gym/envs/CovidRL/model/model_notest.pth'))
        self.case = None
        """
        ...
        Index 9 to 11 represents clustersize
    ...
    def step(self, action):
        ...
        if self.simulated_state["Whether infected"][self.case][self.observed_day] == 0 and (action == 1):
            sum2 = sum2 + 1
        # """
        reward = (-1 * sum1 - self.ratio * sum2) * 100/self.size
